...
-- MobileUI skin registration — white thin ring (modified Aquatic)
local mlbf = LibStub("LibButtonFacade", true)
if mlbf then
    local M = [[Interface\AddOns\MobileUI\Textures\aqua-]]
    local B = [[Interface\AddOns\ButtonFacade\Skins\Aquatic\]]
    mlbf:AddSkin("MobileUI-Circle", {
        Normal = { Width = 36, Height = 36, Texture = M .. [[normal]], Static = true, Color = {1, 1, 1, 1} },
        Pushed = { Width = 34, Height = 34, Texture = M .. [[normal]], Color = {0.5, 0.5, 0.5, 1} },
        Checked = { Width = 34, Height = 34, Texture = B .. [[RoundButtonChecked]], BlendMode = "ADD" },
        Highlight = { Width = 36, Height = 36, Texture = B .. [[RoundButtonHiLight]], BlendMode = "ADD" },
        Border = { Width = 35, Height = 35, Texture = B .. [[RoundButtonBorder]] },
        Disabled = { Hide = true },
        Icon = { Width = 23, Height = 23, TexCoords = {0.07, 0.93, 0.07, 0.93} },
        Cooldown = { Width = 23, Height = 23 },
        Backdrop = { Width = 23, Height = 23, Texture = B .. [[button_bg]] },
        ...
        AutoCastable = { Width = 54, Height = 54, Texture = [[Interface\Buttons\UI-AutoCastableOverlay]] },
        Flash = { Width = 32, Height = 32, Texture = [[Interface\Buttons\UI-QuickslotRed]] },
    }, true)
    print("|cff00ff00[MobileUI] LibButtonFacade + white ring skin loaded OK|r")
else
    print("|cffff0000[MobileUI] LibButtonFacade FAILED to load!|r")
end
