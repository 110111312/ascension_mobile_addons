...
function MobileUILayout:Apply()
    ...
    step("ApplyVehicleExitButton", function() MobileUIFrames.ApplyVehicleExitButton() end)
    ...
    step("ApplyQuickUse", function() MobileUIQuickUse:Apply() end)
...
function MobileUILayout:Revert()
    ...
    if MobileUIQuickUse and MobileUIQuickUse.Revert then MobileUIQuickUse:Revert() end
    ...
    MobileUIFrames.RevertVehicleExitButton()
